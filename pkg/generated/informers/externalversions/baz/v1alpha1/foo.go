...
import (
	...
	versioned "github.com/Marcos30004347/k8s-custom-API-Server/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/Marcos30004347/k8s-custom-API-Server/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/Marcos30004347/k8s-custom-API-Server/pkg/generated/listers/baz/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BazV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BazV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&bazv1alpha1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bazv1alpha1.Foo{}, f.defaultInformer)
}
