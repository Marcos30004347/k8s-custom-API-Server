...
import (
	...
	bazv1beta1 "github.com/Marcos30004347/k8s-custom-API-Server/pkg/apis/baz/v1beta1"
	...
	v1beta1 "github.com/Marcos30004347/k8s-custom-API-Server/pkg/generated/listers/baz/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BazV1beta1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BazV1beta1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&bazv1beta1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bazv1beta1.Foo{}, f.defaultInformer)
}
